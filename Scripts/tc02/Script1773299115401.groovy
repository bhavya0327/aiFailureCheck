...
WebUI.setEncryptedText(findTestObject('manualPassword'), 'g3/DOGG74jC3Flrr3yH+3D/yKbOqqUNM')

WebUI.click(findTestObject('Page_CURA Healthcare Service/manualLogin'))

...
WebUI.click(findTestObject('Object Repository/Page_CURA Healthcare Service/manualMakeApp'))

WebUI.setText(findTestObject('Object Repository/ManualInputUser'), 'John Doe')
